              ...
              <div class="card">
                ...
                <?php  $query=$admin->ret("SELECT * FROM `company` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                            <td><img src="../company/uploads/<?php echo $row['company_imagedb'] ?>" height="800px" width="800px"></td>
                          ...
                          <?php } else { ?>
                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="admin_controller\company_controller.php?update_status=<?php echo $row['company_id'] ?>">Approve</a></td>
                          <?php } ?>
                          <!-- end of approve condition -->

                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\company_controller.php?delete_company=<?php echo $row['company_id'] ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
                        </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
