                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM `user` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                            <td><img src="../user/uploads/<?php echo $row['user_imagedb'] ?>" height="800px" width="800px"></td>
                            <td><?php echo $row['user_name']?></td>
                            <td><?php echo $row['username']?></td>
                            <td><?php echo $row['phone']?></td>

                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\user_controller.php?delete_user=<?php echo $row['user_id'] ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
                        </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
