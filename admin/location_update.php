  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        ...
        <!-------------🟦MAIN CONTENT STARTS------------>
<?php
$id =$_GET['update_location'];  //this is from update button href
$query=$admin->ret("SELECT * FROM `location` where `location_id`=".$id);
...
<div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="admin_controller\location_controller.php" enctype="multipart/form-data">
                ...
                <input type="hidden" name="location_id" value="<?php echo $row['location_id']?>">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['location_name']?>" name="location_name" class="form-control" id="exampleInputUsername2" placeholder="location name">
                      </div>
                    </div>
                    ...
                    <input type="hidden" value="<?php echo $row['location_imagedb'] ?>" name="img">
 
                    <button type="submit" name="update" class="btn btn-primary mr-2">Submit</button>
                    <a class="btn btn-light" href="locationmain.php">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
