  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        <div class="content-wrapper" style="background-image: url('cargoadmin.jpg');   background-size: 1800px auto;  background-repeat: no-repeat;"> <!-- 4. content wrapper starts-->
        ...
        <div class="row">
          <div class="col-md-12 mb-4 stretch-card transparent">
            <div class="card card-tale" style="background-color:#111E2F  !important;">
              <div class="card-body">
