      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 grid-margin stretch-card" id="token_table_ajax">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Service booking payment details</h4>
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <!--table data starts -->
                      <?php $query = $admin->ret("SELECT * FROM ((`booking` INNER JOIN `user` ON booking.user_idb = user.user_id)INNER JOIN `service` ON booking.service_idb = service.service_id ) where `payment_status`='paid'  ORDER BY `booking_date`;");
