              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="location_name" class="form-control" id="exampleInputUsername2" placeholder="location name" required>
                      </div>
                    </div>
                    ...
                    <a class="btn btn-light" href="location_manage.php">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
