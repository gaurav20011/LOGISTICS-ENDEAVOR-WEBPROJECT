                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM ((`feedback` INNER JOIN `user` ON  feedback.user_id = user.user_id) INNER JOIN `company` ON  feedback.company_id_f=company.company_id )");
