...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/loginpage_assets/images/pet_owner.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form autocomplete="off" class="login100-form validate-form p-b-33 p-t-5" action="controller\reg&login_controller.php" method="POST" autocomplete="off">
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<input class="login100-form-btn" type="submit" name="login_cart" value="SIGN IN">
