              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="locations_name" class="form-control" id="exampleInputUsername2" placeholder="location name">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="address" class="form-control" id="exampleInputUsername2" placeholder="address">
                      </div>
                    </div>
