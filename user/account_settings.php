...
<head>
  ...
  <title>pet owner account settings</title>
  <!-- plugins:css -->
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM `shopowner` where `owner_id`=".$s_variable);
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        ...
                        <td><img src="uploads/<?php echo $row['imagedb'] ?>" height="800px" width="800px"></td>
                          ...
                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="account_update.php?update_account=<?php echo $row['owner_id'] ?>">Update</a></td>
                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="controller\account_settings_controller.php?delete_account=<?php echo $row['owner_id'] ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
                         </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
