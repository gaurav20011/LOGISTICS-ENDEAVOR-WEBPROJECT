  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        ...
        <!-------------🟦MAIN CONTENT STARTS------------>
<?php
$id =$_GET['update_locations'];  //this is from update button href
$query=$admin->ret("SELECT * FROM `locations` where `locations_id`=".$id);
...
<div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="controller/locations_controller.php" enctype="multipart/form-data">
                    
                <!--passing location id as hidden-->
                <input type="hidden" name="locations_id" value="<?php echo $row['locations_id']?>">

                  <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Location Name</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['locations_name']?>" name="locations_name" class="form-control" id="exampleInputUsername2" placeholder="location name">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['address']?>" name="address" class="form-control" id="exampleInputUsername2" placeholder="address">
                      </div>
                    </div>
                    ...
                    <a class="btn btn-light" href="locations_manage.php">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
