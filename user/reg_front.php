				...
				<div class="card-body">
					<form autocomplete="off" action="controller\reg&login_controller.php" method="POST" enctype="multipart/form-data">
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5"type="text" name="user_name" placeholder="User name" required pattern="[a-zA-Z'-'\s]*" title="No numbers or special characters are allowed">
								</div>
							</div>
						</div>
						...
						<div class="form-row p-t-20">
							<label class="label label--block">Are you an existing user?<a href="login_front.php">Login here</a></label>
						</div>
						<div>
