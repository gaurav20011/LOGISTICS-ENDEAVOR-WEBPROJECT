...
if (!isset($_SESSION['company_id'])) { //$_SESSION is from admin loginback.php page
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="controller\service_controller.php" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="company_id" value="<?php echo $s_variable ?>">

                  <div class="form-group row">
                    <label for="exampleInputUsername2" class="col-sm-3 col-form-label">service Name</label>
                    <div class="col-sm-9">
                      <input type="text" name="service_name" class="form-control" id="exampleInputUsername2" placeholder="service name" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="service_price" class="form-control" id="exampleInputUsername2" placeholder="service price" required>
                    </div>
                  </div>
                  ...
                  <button type="submit" name="create_service" class="btn btn-primary mr-2">Submit</button>
