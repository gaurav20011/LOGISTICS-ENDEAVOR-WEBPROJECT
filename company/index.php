...
<body>
  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="content-wrapper" style="background-image: url('companyindex.jpg');   background-size: 1305px auto;  background-repeat: no-repeat;"> <!-- 4. content wrapper starts-->
...
<div class="row">
  <div class="col-md-12 mb-4 stretch-card transparent">
    <div class="card card-tale" style="background-color:#1F516A  !important;">
      <div class="card-body">
        <p class="mb-4">Company Dashboard</p>
      </div>
    </div>
  </div>
