                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <!--table data starts -->
                                            <?php $query = $admin->ret("SELECT * FROM `booking` INNER JOIN `user` ON booking.user_idb = user.user_id where `company_idb`=$s_variable  AND `booking_status`='Goods picked' ORDER BY `booking_date` ;");
                                            while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                    ...
                                                    <form class="forms-sample" method="POST" action="controller\booking_controller.php" enctype="multipart/form-data">
                                                        ...
                                                        <td>
                                                            <div class="form-group row">
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="current_location" class="form-control" id="exampleInputUsername2" placeholder="Location" required>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td> <input type="submit" name="update_goods_location" value="Update" class="btn btn-primary mr-2"></td>
                                                    </form>
                                                    ...
                                                    <td>
                                                    <?php if (isset($row['current_location'])) {
                                                ...
                                                <td><a type="button" href="controller/booking_controller.php?mark_reached=<?php echo $row['booking_id']?>" class="btn btn-warning btn-rounded btn-fw">mark as reached</a></td>
