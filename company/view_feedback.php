...
<head>
  ...
  <title>company feedback view</title>
  <!-- plugins:css -->
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">User feedbacks for your services</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM ((`feedback` INNER JOIN `user` ON  user.user_id = feedback.user_id) INNER JOIN `company` ON  company.company_id=feedback.company_id_f ) where `company_id_f`='$s_variable'  ");
